...
//
// The `./page-data.js` import is for its side effect and is load-bearing:
// that module is what assigns window.HHVC_DATA (after pulling in all 19
// pages/*.js files, which register themselves onto window.HHVC_PAGES).
// Importing it here makes the ordering a property of the module graph
// rather than of a hand-maintained script-tag list, so the throw below
// can only ever fire on genuinely malformed page data.
