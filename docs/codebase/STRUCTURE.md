...
- Directory organization: layer-ish split (pages / js / css / build_scripts / tests) plus one nested Vite app under `forms/`; `js/` itself is nine feature folders, not one flat directory (see the folder table above)
