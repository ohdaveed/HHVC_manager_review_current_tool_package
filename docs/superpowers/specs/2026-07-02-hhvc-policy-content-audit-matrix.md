...
| ratsReport | sections[0].steps[2].callout.text (privacy) | HHVC does not share the reporter’s identity with the property owner or manager. | reporter privacy | program-manager-reporter-privacy | Stakeholder attestation — identity not shared with property owner | verified | high | Keep current; also in related *Tenant rights and reporting* card. | Step 3 callout privacy sentence. |
...
| cockroachesReport | sections[0].steps[2].callout.text (privacy) | HHVC does not share the reporter’s identity with the property owner or manager. | reporter privacy | program-manager-reporter-privacy | Stakeholder attestation — identity not shared with property owner | verified | high | Keep current; also in related *Tenant rights and reporting* card. | Step 3 callout privacy sentence. |
...
| bedBugsReport | sections[0].steps[2].callout.text (privacy) | HHVC does not share the reporter’s identity with the property owner or manager. | reporter privacy | program-manager-reporter-privacy | Stakeholder attestation — identity not shared with property owner | verified | high | Keep current; also in related *Tenant rights and reporting* card. | Step 3 callout privacy sentence. |
...
| mosquitoesReport | sections[0].steps[2].callout.text (privacy) | HHVC does not share the reporter’s identity with the property owner or manager. | reporter privacy | program-manager-reporter-privacy | Stakeholder attestation — identity not shared with property owner | verified | high | Keep current; also in related *Tenant rights and reporting* card. | Step 3 callout privacy sentence. |
...
| vegetationReport | sections[0].steps[2].callout.text (privacy) | HHVC does not share the reporter’s identity with the property owner or manager. | reporter privacy | program-manager-reporter-privacy | Stakeholder attestation — identity not shared with property owner | verified | high | Keep current; also in related *Tenant rights and reporting* card. | Step 3 callout privacy sentence. |
| vegetationReport | sections[1].cards[3].text (privacy) | HHVC does not share the reporter’s identity with the property owner or manager. | reporter privacy | program-manager-reporter-privacy | Stakeholder attestation — identity not shared with property owner | verified | high | Keep current; privacy portion of tenant-rights related card. | Combined card also includes retaliation intro (still blocked). |
...
| moldReport | sections[0].steps[2].callout.text (privacy) | HHVC does not share the reporter’s identity with the property owner or manager. | reporter privacy | program-manager-reporter-privacy | Stakeholder attestation — identity not shared with property owner | verified | high | Keep current; also in related *Tenant rights and reporting* card. | Step 3 callout privacy sentence. |
...
| program-manager-reporter-privacy | HHVC Program Manager — reporter privacy | Operational authority for complainant identity not shared with property owner |
