...
| Spotlight 1              | `spotlight_1`                | not recorded                           | **two fixed slots (single block each; max 2 total)** | one type: `Spotlight`, no chooser                                                              | `section` with `component: 'spotlight'`                         |
...
| Spotlight 1                        | `spotlight_1`                                                                | no                     | single            | `Spotlight` block                                                     | —                                              |
| Spotlight 2                        | `spotlight_2`                                                                | no                     | single            | `Spotlight` block                                                     | —                                              |
