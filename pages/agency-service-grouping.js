      ...
      cards: [
        {
          ...
          text: 'Report rats, mice, raccoons, skunks, opossums, bats, or other animals in or around a building.',
          target: 'ratsReport',
        ...
        },
        {
          ...
          text: 'Report bed bugs, fleas, mites, ticks, or body lice.',
          target: 'bedBugsReport',
          karl: 'Services block entry — an "SF.gov page" link only; this card\'s `text` description has no home in the real schema (see section-level karl note above).',
        },
        {
          title: 'Report cockroaches or flies',
          text: 'Report cockroaches or flies in a home, shared area, SRO, hotel, or workplace.',
          target: 'cockroachesReport',
          karl: 'Services block entry — an "SF.gov page" link only; this card\'s `text` description has no home in the real schema (see section-level karl note above).',
        },
        {
          title: 'Report mosquitoes or a dead bird',
          text: 'Report mosquitoes or standing water, or a dead bird for West Nile virus surveillance.',
        ...
        },
        {
          ...
          text: 'Report garbage, clutter, waste, overgrown vegetation, mold, or unsanitary conditions.',
