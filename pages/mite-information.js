...
window.HHVC_PAGES['miteInfo'] = {
  ...
  sections: [
    ...
    },
    {
      ...
      callout: {
        karl: 'Body note: Not medical advice',
    ...
    },
    {
      ...
      karl: 'Body: Tropical rat mite link to rodent infestations',
      kind: 'body',
      paragraphs: [
      ...
      cards: [
        {
          ...
          target: 'ratsPrevent',
          karl: 'Body link to primary rodent Information page',
        },
        {
    ...
    },
    {
      ...
      karl: 'Body: Common signs (non-diagnostic)',
      kind: 'body',
      bullets: [
