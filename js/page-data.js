...
window.HHVC_DATA = {
  ...
  order: [
    ...
    ['ratsReport', 'Transaction: Report rats, mice, or other animals'],
    ['cockroachesReport', 'Transaction: Report cockroaches or flies'],
    ['bedBugsReport', 'Transaction: Report bed bugs, fleas, or other biting pests'],
    ['bedBugsInfo', 'Information: Bed bug rules and prevention'],
    ['mosquitoesReport', 'Transaction: Report mosquitoes or a dead bird'],
    ['pigeonsReport', 'Transaction: Report pigeons'],
    ['garbageReport', 'Transaction: Report garbage, clutter, mold, or unsanitary conditions'],
