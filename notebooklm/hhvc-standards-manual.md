...
The Karl CMS functions as a relational database of pages and files [144, 196]. To maintain structural integrity and a unified user experience across SF.gov, the platform supports exactly **14 distinct content types** organized into three functional categories [43]. 

HHVC editors must understand the technical boundaries and approved use cases for all 14 content types to make correct architectural decisions [243]:
...
Outreach pages inform the public about active City initiatives, scheduled meetings, or time-sensitive announcements [44, 217].
...
Department support pages describe the internal structure, meetings, data assets, and formal documents of City agencies [44].
...
| :--- | :---: | :--- |
| File a cockroach, mold, or bed bug report online | **Transaction** | *Report cockroaches* [246] |
| Pay an annual apartment program fee or late fee | **Transaction** | *Pay your Healthy Housing fee* [246] |
| Learn how to seal cracks to keep mice out of a kitchen | **Information** | *Keep rats and mice out* [246] |
| Understand what steps to take after filing a complaint | **Step-by-step** | *What happens after you report* [246] |
| Prepare a unit for an upcoming SRO hygiene inspection | **Step-by-step** | *Get ready for an SRO inspection* [246] |
| Review legal requirements of a Notice of Violation (NOV) | **Information** | *Understand a notice of violation* [246] |
| Find and download the landlord Bed Bug Disclosure form | **Resource Collection** | *Vermin prevention guides and forms* [246] |
| View the program mission, office hours, and district map | **About** | *About Healthy Housing and Vector Control* [246] |
...
* *The Problem*: Stuffer pages that pack biology, local laws, and fee schedules onto a report page overwhelm residents, leading to abandoned forms or misrouted complaints [235].
* *The Standard*: A page titled "Report cockroaches" [Sentence Case, `< 65 characters`] must focus exclusively on the reporting action [306, 307]. It must outline eligibility, required form fields, and the 311 button [83, 221]. It must *never* include paragraphs on cockroach breeding habits. 
* *The Solution*: Use Karl's **Relational Content** tags [144, 196]. Link the reporting Transaction page to a separate, educational Information page (e.g., "Prevent cockroaches") in the right-hand Related panel [244, 323].

#### **Rule 2: The "No Placeholder" Rule**
Every staged and published page must be fully functional and complete [247].
* *The Problem*: Creating stub pages with "Under Construction" banners, "Coming Soon" text, or incomplete checklists erodes municipal credibility and frustrates users [58, 247].
* *The Standard*: Do not submit a page for governance check or stage it on the live environment until all citable laws are verified, all PDF files are uploaded to their designated Collections, and all cross-page hyperlinks are functional [90, 247]. 

#### **Rule 3: Strict Layout Enforcement**
Editors must work strictly within the design boundaries of Karl CMS templates [143, 248].
* *The Problem*: Attempting to bypass Karl's styling constraints by using bold text for fake headings, typing hyphens to create lines, or using custom bullet symbols breaks mobile responsiveness and disrupts assistive screen readers [248, 263].
* *The Standard*: 
...
* **Audience Selector Lanes:** Must group onward links into clear, distinct audience-focused lanes [219]:
  1. *Report a Problem:* Direct links to 311 online reporting forms and violation search tools [220].
...
4. **What to Know Before You Start:** (Rendered in a prominent gray box below the description) [301].
   * *Cost:* Explicit cost or fee information [99, 301]. If free, must state "Free" [220, 222].
   * *Things to know:* Key eligibility rules, documentation needed, or prep requirements [99, 301].
...
7.  **Supporting Information:** Located near the bottom of the page [255]. Supporting details may be placed in **expandable accordions** (only FAQs, term definitions, or secondary references) [215, 255].
    *   *Critical Restriction:* Mandatory compliance instructions, SRO fees, deadlines, or Notice of Violation (NOV) response steps must **never** be hidden inside accordions [215].
...
* **Steps (Up to 15, target under 5):** Bulleted, numbered, or sequential segments [248].
  * *Each step must include:* Title, cost, time the step takes, and a detailed description [249].
  * *Transaction Links:* Any individual step can link to exactly one (or zero) Transaction pages on SF.gov [95, 248]. When a user navigates to a transaction from a Step-by-step page, Karl automatically displays a "Part of" breadcrumb at the top of that Transaction page [96].
...
* **Body Component:** Editors can expand options to add exactly three types of assets [17]:
  1. *Documents:* Downloadable, accessible PDF files (such as required pesticide notices or bed bug log templates) [17, 314].
  2. *Resources:* External trustworthy links [17, 195].
  3. *Data Stories:* Embedded Looker Studio or PowerBI dashboard links [17, 227].
...
*   **CTA Labeling:** The button must use active, verb-first language [322]:
    ...
    *   *Prohibited:* `Click here`, `Submit`, or `Get started` [94, 311]
...
3.  **Extension Requests:** Public content must explain that extensions are possible only if the property owner contacts the assigned inspector *before* the compliance deadline and provides a certified, written contract with a licensed Pest Control Operator (PCO) or general contractor [109].
...
*Note: SRO and Hotel Program fees are billed annually on March 31 for the upcoming fiscal cycle, ranging from **$554.00** (under 20 units) up to **$1,976.00** (structures with more than 175 units) [103].*
...
*   **Branching Rules:**
    *   *If "Presentation" selected:* Show fields for preferred dates, expected audience size, and specific topic needs [9].
    *   *If "Tabling/Event" selected:* Show fields for event date, physical location, and expected community attendance [9].
    *   *If "Printed Materials" selected:* Show fields for material type, language preference, and pickup/delivery options [9].
...
*   **Health Code Article 11 (Vermin Nuisances):** Public pages must summarize this code in clear terms: *“Under San Francisco Health Code Article 11, property owners are legally required to keep their buildings clean, watertight, and completely free of rodent and insect infestations”* [203].
*   **Health Code Article 11A (Bed Bug Abatement):** Summarize this code as: *“Under San Francisco Health Code Article 11A, landlords must investigate any reported bed bug concern within 72 hours, inspect all adjacent units within 5 business days, and hire a licensed professional to treat active infestations”* [109].
...
*   *Approved Link:* `View the full text of [Health Code Article 11](url) on the municipal code website.` [239]
*   *Prohibited Link:* `Click here to read the law.` [311]
