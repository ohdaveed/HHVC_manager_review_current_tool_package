...
window.HHVC_PAGES['scopeInfo'] = {
  ...
  sections: [
    ...
    },
    {
      ...
      karl: 'Body: Article 11 issue matching links',
      kind: 'body',
      cards: [
        {
          title: 'Report rats or mice',
          text: 'Report an active rat or mouse problem.',
          target: 'ratsReport',
          karl: 'Links: Related Transaction page',
        },
        {
          title: 'Report cockroaches',
          text: 'Report an active cockroach problem.',
          target: 'cockroachesReport',
          karl: 'Links: Related Transaction page',
        },
        {
          title: 'Report bed bugs',
          text: 'Report an active bed bug problem in rental housing.',
          target: 'bedBugsReport',
          karl: 'Links: Related Transaction page',
        },
        {
          title: 'Report mosquitoes',
          text: 'Report mosquitoes or standing water.',
          target: 'mosquitoesReport',
          karl: 'Links: Related Transaction page',
        },
        {
          title: 'Pigeons and housing health',
          text: 'Learn about bird or pigeon nuisances tied to droppings or unsanitary conditions.',
          target: 'pigeonInfo',
          karl: 'Links: Related Information page',
        },
        {
          title: 'Mites and housing health',
          text: 'Learn about mite concerns linked to pests in housing.',
          target: 'miteInfo',
          karl: 'Links: Related Information page',
        },
        {
          title: 'Report garbage or clutter',
          text: 'Report garbage, clutter, or animal waste that may attract pests.',
          target: 'garbageReport',
          karl: 'Links: Related Transaction page',
        },
        {
          title: 'Report overgrown vegetation',
          text: 'Report overgrown plants or brush that may shelter pests.',
          target: 'vegetationReport',
          karl: 'Links: Related Transaction page',
        },
        {
          title: 'Report pigeons',
          text: 'Report active pigeon roosting or feeding problems.',
          target: 'pigeonsReport',
          karl: 'Links: Related Transaction page',
        },
        {
          title: 'Report mold from humidity or condensation',
          text: 'Report mold from humidity, condensation, or poor ventilation.',
          target: 'moldReport',
          karl: 'Links: Related Transaction page',
        },
      ],
