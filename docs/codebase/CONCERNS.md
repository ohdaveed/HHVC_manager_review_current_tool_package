...
| -------- | --------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| high     | Review import/export can destroy reviews if merge regresses; no unit coverage at all — both modules are browser-only with no `module.exports` | `AGENTS.md` Local persistence; `tests/e2e/import-export.spec.js` and `tests/e2e/merge-verification.spec.js` are the only coverage                 | Manager decisions wiped                                                                                                   | Keep both e2e specs green; manual round-trip after touching merge/import/export; a green CI run is evidence for those two scenarios and nothing else on this path |
