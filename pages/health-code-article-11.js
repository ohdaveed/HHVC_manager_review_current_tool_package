...
window.HHVC_PAGES['article11Guide'] = {
  ...
  reading: 'Grade 7',
  karlGuide: {
    path: 'Content → Content → Body or Table',
    panel: 'Content',
    block: 'Body / Table',
    field: 'Body or Table values',
    rawField: 'content',
    steps: [
      'Open Karl admin → Pages → Add child page → Report.',
      'Open Content and choose Body for prose or Table for tabular material.',
      'Use Heading 2 for visible section headings; enter Table Description, Caption, and rich-text columns for tables.',
    ],
    evidence: 'E1',
    status: 'confirmed',
  },
