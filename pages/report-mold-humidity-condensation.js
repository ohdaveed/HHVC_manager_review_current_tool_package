  ...
  sections: [
    {
      ...
      steps: [
        ...
        },
        {
          ...
          callout: {
            karl: 'Callout block inside the "Tell us where the problem is" Section specifics: single rich text field, no separate title (this mockup callout has no title key, so no heading mismatch here). Text: mold-test-kit guidance note.',
    ...
    },
    {
      ...
      karl: 'Best real-schema fit: a second things_to_know entry. Title: "When HHVC may review mold". Text: the 2 paragraphs below (Article 11 10-square-foot threshold, self-clean guidance below that threshold). Same ordering caveat as the section above — things_to_know sits before what_to_do on the real form.',
      kind: 'body',
      paragraphs: [
    ...
    },
    {
      ...
      karl: 'Best real-schema fit: a third things_to_know entry. Title: "How your report is processed". Text: the bulleted list below (after-report expectations, weekday processing note, enforcement statement). Same ordering caveat as the two sections above — things_to_know sits before what_to_do on the real form.',
      kind: 'body',
      bullets: [
