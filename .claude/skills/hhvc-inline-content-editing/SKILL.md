...
description: HHVC repo: click-to-edit on the rendered mockup — the deliberately narrow scope, why cards carry no data-rewrite-field, section_edits being derived not accumulated, the reapply/re-render infinite-loop guard, and the CSV round-trip limitation. Load before editing js/inline-content-edit*.js.
---
